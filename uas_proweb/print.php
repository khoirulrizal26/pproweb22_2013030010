...
<html>
    <head>
        ...
        <title>MOCHAMMAD KHOIRUL RIZAL | 2013030010 | 2B</title>
        <!-- CSS only -->
       ...
       <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
        ...
        <div class="container">
            ...
            <a href="index.php"> <button class="btn btn-primary mb-2">Lihat Data</button></a>
            <button class="btn btn-success mb-2" id="cetak">Print Data</button>
