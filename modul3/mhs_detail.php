...
include 'koneksi.php';
	$npm = $_GET['npm'];
	$sql = "SELECT * FROM mhss WHERE npm='$npm'";
	$res = $conn->query($sql);
	$dat = $res->fetch_assoc();
?>
<!DOCTYPE html>
...
NPM
<br>
<input type="text" name="npm" id="npm" value="<?php echo $dat['npm']?>">
<br>Nama
<br>
<input type="text" name="nama" id="nama" size="30" value="<?= $dat['nama']?>">
<br>Alamat
<br>
<input type="text" name="alamat" id="alamat" size="50" value="<?= $dat['alamat']?>">
<br>
